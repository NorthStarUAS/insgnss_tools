...
att_ax[0].plot(df0_nav["phi_deg"], color="g", label="On Board")
att_ax[0].plot(df1_nav["phi_deg"], label=filter.name)
att_ax[0].grid()

att_ax[1].set_ylabel("Pitch (deg)", weight="bold")
att_ax[1].plot(df0_nav["theta_deg"], color="g", label="On Board")
att_ax[1].plot(df1_nav["theta_deg"], label=filter.name)
att_ax[1].grid()

att_ax[2].set_ylabel("Yaw (deg)", weight="bold")
att_ax[2].plot(df0_nav["psi_deg"], color="g", label="On Board")
att_ax[2].plot(df1_nav["psi_deg"], label=filter.name)
...
plt.plot(df1_nav["altitude_m"], label=filter.name)
...
plt.plot(df1_nav["longitude_deg"], df1_nav["latitude_deg"], label=filter.name)
plt.grid()
plt.legend(loc=0)
ax = plt.gca()
ax.axis("equal")
