...
setup(name="insgnss_tools",
      ...
      ext_modules=[
          Extension("insgnss_tools.nav_structs",
                    ...
                    sources=["src/nav_eigen/nav_structs.cpp"],
                    depends=["src/nav_eigen/nav_structs.h"]),
          Extension("insgnss_tools.ekf15_eigen",
                    sources=["src/nav_eigen/ekf15_eigen_pybind11.cpp",
                             "src/nav_eigen/ekf15_eigen.cpp",
                             "src/nav_eigen/nav_functions.cpp"],
                    depends=["src/nav_eigen/ekf15_eigen.h",
                             "src/nav_eigen/nav_constants.h",
                             "src/nav_eigen/nav_functions.h"]),
          Extension("insgnss_tools.ekf15_mag",
                    sources=["src/nav_eigen/ekf15_mag_pybind11.cpp",
                             "src/nav_eigen/ekf15_mag.cpp",
                             "src/nav_eigen/nav_functions.cpp",
                             "src/nav_common/coremag.c"],
                    depends=["src/nav_eigen/ekf15_mag.h",
                             "src/nav_eigen/nav_constants.h",
                             "src/nav_eigen/nav_functions.h",
