...
void EKF15_mag_unified::set_config(NAVconfig config) {
    this->config = config;
}

NAVconfig EKF15_mag_unified::get_config() {
    return config;
}

void EKF15_mag_unified::default_config()
{
...
NAVdata EKF15_mag_unified::init(IMUdata imu, GPSdata gps) {
    I15.setIdentity();
    I3.setIdentity();
...
NAVdata EKF15_mag_unified::update(IMUdata imu, GPSdata gps) {
...
BOOST_PYTHON_MODULE(EKF15_mag_unified)
{
    class_<EKF15_mag_unified>("EKF15_mag_unified")
        .def("set_config", &EKF15_mag_unified::set_config)
        .def("init", &EKF15_mag_unified::init)
        .def("update", &EKF15_mag_unified::update)
    ;
}
