...
void EKF15_bla::set_config(NAVconfig _config) {
    config = _config;
}

NAVconfig EKF15_bla::get_config() {
    return config;
}

void EKF15_bla::default_config()
{
...
void EKF15_bla::time_update(IMUdata imu) {
...
void EKF15_bla::measurement_update(GPSdata gps) {
    // ==================  GPS Update  ===================
